...
-- Diagnostic keymaps
-- First two is default on Neovim 0.11 already
...
vim.keymap.set({ 'n', 'v' }, '<leader>y', '"+y', { desc = 'Copy to system clipboard, include newline' })
vim.keymap.set('n', '<leader>yg', '"+yg_', { desc = "Copy to system clipboard, doesn't include newline" })
